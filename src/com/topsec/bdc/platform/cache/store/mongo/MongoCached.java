package com.topsec.bdc.platform.cache.store.mongo;
...
/**
 * @author baiyanwei the MongoDB cache.
 */
@ServiceInfo(description = "MongoDB cached for Platform", configurationPath = "application/services/cacheService/mongoCached/")
public class MongoCached implements ICache {
